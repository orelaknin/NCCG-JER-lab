...
def main(host_name):
    """
    Main function to set a host in maintenance.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Set host in maintenance mode in Zabbix.')
    parser.add_argument('hostname', type=str, help='The hostname of the target machine to put in maintenance')
